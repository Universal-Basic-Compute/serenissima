      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-amber-200">
          <div className="h-48 overflow-hidden">
            <Image 
              src="/public_assets/images/knowledge/historical-accuracy.png" 
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-amber-200">
          <div className="h-48 overflow-hidden">
            <Image 
              src="/public_assets/images/knowledge/venetian-guilds.png" 
              alt="Venetian Guilds" 
              width={800}
              height={400}
              className="w-full h-full object-cover transition-transform hover:scale-105"
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-amber-200">
          <div className="h-48 overflow-hidden">
            <Image 
              src="/public_assets/images/knowledge/guild-leadership.png" 
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-amber-200">
          <div className="h-48 overflow-hidden">
            <Image 
              src="/public_assets/images/knowledge/trade-routes.png" 
