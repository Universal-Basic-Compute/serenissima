          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <p className="text-sm">
                  Hire AI citizens to work in your businesses or find employment in AI-owned establishments. AI workers have skills appropriate to their social class and profession, and they expect fair wages for their labor.
                </p>
              </div>
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <p className="text-sm">
                  Borrow from or lend to AI citizens through the banking system. AI lenders offer competitive rates and terms, while AI borrowers repay their loans according to the agreed schedule.
                </p>
              </div>
            </div>
          </div>
