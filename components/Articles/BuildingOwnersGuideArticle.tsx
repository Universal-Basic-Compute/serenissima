    ...
    <div className="fixed inset-0 bg-black/80 z-50 overflow-auto">
      <div className="bg-amber-50 border-2 border-amber-700 rounded-lg p-6 max-w-4xl mx-auto my-20">
        ...
        <div className="prose prose-amber max-w-none">
          ...
          <p className="mb-4">
            In La Serenissima, buildings are not merely structures—they are the physical manifestation of economic power, social status, and strategic vision. As a property developer in Renaissance Venice, your buildings will form the backbone of your commercial empire and determine your place in Venetian society.
          </p>
          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm">
                  Buildings near the Rialto Bridge, Piazza San Marco, or major churches benefit from increased foot traffic and prestige. The value gradient decreases with distance from these landmarks.
                </p>
              </div>
          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <p className="mb-3">
              Proper maintenance is essential for preserving and increasing building value:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm mb-3">
                  All buildings require ongoing maintenance to prevent deterioration. Neglected buildings suffer reduced rents, increased vacancy, and eventually structural problems that are costly to repair.
                </p>
              ...
              <div>
                ...
                <p className="text-sm">
                  Commissioning artwork, ornate facades, and decorative elements increases a building's prestige and the rents it can command. These investments typically appreciate over time, unlike basic maintenance expenses.
                </p>
              </div>
            </div>
          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <p className="text-sm">
                  Investing in ornate facades, especially on buildings facing major canals or squares, significantly increases prestige and rental potential. Commissioning work from renowned artists creates buildings that become landmarks in their own right.
                </p>
              </div>
            ...
            <div className="mt-4 bg-amber-50 p-3 rounded border border-amber-200">
              <p className="italic text-amber-800">
                <span className="font-bold">ROI Analysis:</span> Before undertaking major improvements, calculate the expected return on investment. As a general rule, improvements should increase annual income by at least 15-20% of the improvement cost to be worthwhile.
              </p>
            </div>
          </div>
