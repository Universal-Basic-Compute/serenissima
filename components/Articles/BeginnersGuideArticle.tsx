            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-800">
                    Land is the foundation of wealth in Venice. Navigate the map to find available parcels (highlighted in a lighter color), then click to view details and purchase using your $COMPUTE tokens. Consider location carefully—properties near the Grand Canal or major squares command higher values.
                  </p>
                </div>
              </div>
            </div>
