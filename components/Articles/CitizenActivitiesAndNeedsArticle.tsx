        ...
        <div className="prose prose-amber max-w-none">
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: FaRoute, title: "Fetch Resource", description: "Citizens may travel to a source building to pick up resources as per a contract. Upon arrival, they attempt to acquire the specified resources, which are then carried (owned by the contract's buyer) to an ultimate destination, often triggering a subsequent travel activity." },
