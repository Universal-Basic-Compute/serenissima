    ...
    <div className="fixed inset-0 bg-black/80 z-50 overflow-auto">
      <div className="bg-amber-50 border-2 border-amber-700 rounded-lg p-6 max-w-4xl mx-auto my-20">
        ...
        <div className="prose prose-amber max-w-none">
          ...
          <p className="mb-4">
            In La Serenissima, guilds serve as powerful player organizations focused on coordinating members for larger economic and political operations. Unlike their historical counterparts, modern guilds in the game are more flexible in structure while maintaining significant economic influence.
          </p>
          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <ul className="list-disc pl-5 space-y-1 text-xs text-amber-800">
                  ...
                  <li>Regular elections for leadership positions</li>
                </ul>
              </div>
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <ul className="list-disc pl-5 space-y-1 text-xs text-amber-800">
                  <li>Voting rights proportional to assets or investments</li>
                  <li>Tiered membership levels with different voting powers</li>
                  <li>Contribution-based influence in specific decisions</li>
                  <li>Stake-weighted voting on economic matters</li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-4 grid md:grid-cols-2 gap-4">
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                <h5 className="font-bold text-amber-900 mb-1">Meritocratic Systems</h5>
                <p className="text-sm text-amber-800 mb-2">
                  Guilds focused on expertise may implement merit-based governance:
                </p>
                <ul className="list-disc pl-5 space-y-1 text-xs text-amber-800">
                  <li>Voting rights earned through demonstrated skill</li>
                  <li>Leadership positions based on achievement</li>
                  <li>Specialized committees for different expertise areas</li>
                  <li>Apprentice-journeyman-master progression for voting rights</li>
                </ul>
              </div>
              ...
              <div className="bg-amber-50 p-3 rounded border border-amber-200">
                ...
                <p className="text-sm text-amber-800 mb-2">
                  Many guilds combine elements from different systems:
                </p>
                <ul className="list-disc pl-5 space-y-1 text-xs text-amber-800">
                  <li>Democratic elections with wealth-weighted committees</li>
                  <li>Equal votes on social matters, weighted votes on economic decisions</li>
                  <li>Rotating leadership with permanent advisory councils</li>
                  <li>Consensus-seeking for major decisions, majority rule for minor ones</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-100 p-4 rounded-lg border border-amber-300 mb-6">
            ...
            <div className="bg-amber-50 p-3 rounded border border-amber-200">
              ...
              <ul className="list-disc pl-5 space-y-1 text-amber-800">
                <li><span className="font-medium">Collective Voting Power</span> - Guilds can coordinate voting on city-wide matters, amplifying their members' influence</li>
                <li><span className="font-medium">Proposal Rights</span> - Guild leadership can submit proposals for consideration in governance decisions</li>
                <li><span className="font-medium">Representation</span> - Larger guilds may gain dedicated representation in future governance mechanisms</li>
                <li><span className="font-medium">Economic Regulation</span> - Guilds may gain the ability to influence regulations in their specific industries</li>
              </ul>
              <p className="mt-2 text-amber-800 italic">
                Note: Additional guild governance features are planned for future updates to La Serenissima.
              </p>
            </div>
          </div>
