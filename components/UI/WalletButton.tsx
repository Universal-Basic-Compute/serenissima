      ...
      {isConnected && citizenProfile ? (
        citizenProfile.username ? (
          ...
          <button
            ...
            className={`bg-red-800 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg text-lg shadow-lg transition-all duration-150 ease-in-out transform hover:scale-105 ${className}`}
          >
            Enter Venice
          </button>
        )
