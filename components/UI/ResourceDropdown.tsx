...
const ResourceDropdown: React.FC<ResourceDropdownProps> = ({ 
  ...
  const getIconPath = (iconName: string) => {
    ...
    if (!iconName) {
      ...
      return `/public_assets/images/resources/default.png`;
    }
    ...
    const finalPath = `/public_assets/images/resources/${iconName}`;
                                ...
                                <img 
                                  ...
                                  onError={(e) => {
                                    ...
                                    if (!(e.target as HTMLImageElement).dataset.fallback) {
                                      console.log(`%c[ResourceDropdown] Trying fallback icon: /public_assets/images/resources/default.png`, 'color: #22c55e;');
