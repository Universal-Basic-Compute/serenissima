    ...
    const loadImages = async () => {
      const imagePromises = nodes.map(node => {
        return new Promise<CitizenNode>(resolve => {
          const img = new Image();
          // node.imageUrl should contain the primary URL or /public_assets/images/citizens/username.jpg
          // Final fallback to /public_assets/images/citizens/default.jpg if node.imageUrl is null or fails
          img.src = node.imageUrl || '/public_assets/images/citizens/default.jpg';
          ...
          img.onerror = () => {
            ...
            if (img.src !== '/public_assets/images/citizens/default.jpg') {
              const defaultImg = new Image();
              defaultImg.src = '/public_assets/images/citizens/default.jpg';
