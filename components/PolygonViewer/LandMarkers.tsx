        ...
        return (
          <div
            ...
            style={{
              ...
              width: `${Math.max(25, 75 * scale)}px`, // Scale width with zoom level - quarter of the original size
              height: `${Math.max(25, 75 * scale)}px`, // Scale height with zoom level - quarter of the original size
