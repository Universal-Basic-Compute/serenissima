            ...
            <li>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14.5c0 .828 2.686 1.5 6 1.5s6-.672 6-1.5M9 14.5V18c0 .828 2.686 1.5 6 1.5s6-.672 6-1.5v-3.5M9 14.5V9.5m0 5c0-.828 2.686-1.5 6-1.5s6 .672 6 1.5m-12 0V9.5m12 5V9.5m-12 0c0-.828 2.686-1.5 6-1.5s6 .672 6 1.5m-6-1.5V4" />
                </svg>
              </button>
            </li>
            <li>
