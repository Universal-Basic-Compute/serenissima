...
export async function GET(request: NextRequest) {
  try {
    ...
    const unemployedCitizens = citizensResponse
      .filter(citizen => {
    ...
    console.log(`Found ${unemployedCitizens.length} unemployed citizens out of ${citizensResponse.length} total citizens`);
    
    // Calculate job market statistics
