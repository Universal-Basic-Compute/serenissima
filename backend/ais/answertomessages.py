        ...
        for message_record in unread_messages:
            ...
            if not dry_run:
                        ...
                        if response_content:
                            if instant_mode:
                                ...
                                if create_direct_message(ai_username, sender_username, response_content, "reply", in_reply_to):
                                    ...
                                    print(f"{LogColors.OKGREEN}Created direct message from {ai_username} to {sender_username}.{LogColors.ENDC}")
                                else:
                ...
                if dry_run_should_respond:
                    ...
                    if instant_mode:
                        print(f"[DRY RUN] Would create direct message from {ai_username} to {sender_username} (instant mode)")
                    else:
