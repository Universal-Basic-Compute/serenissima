...
def create_notification_for_building_owner(tables, building_id: str, owner: str, ai_username: str, 
    ...
    try:
        ...
        notification = {
            ...
            "Content": f"The lease amount for your building {building_id} has been adjusted from {old_lease} to {new_lease} ducats by the landowner {ai_username}. Reason: {reason}",
            "CreatedAt": now,
            "ReadAt": None,
            "Details": json.dumps({
