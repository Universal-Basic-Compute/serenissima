...
export class AssetService {
      ...
      Object.entries(ownerCoatOfArmsMap).forEach(([owner, url]) => {
        ...
        if (url) {
          ...
          const urlsToTry = [
            ...
            `${window.location.origin}/public/assets/images/coat-of-arms/${owner}.png`,
            ...
            `/public/assets/images/coat-of-arms/external/${encodeURIComponent(`https://serenissima.ai/public/assets/images/coat-of-arms/${owner}.png`)}`
          ...
          const tryLoadImage = async (): Promise<HTMLImageElement> => {
            ...
            const allUrlsToTry = [
              ...
              `${window.location.origin}/public/assets/images/coat-of-arms/default.png`
            ];
  ...
  public async getBuildingImagePath(buildingType: string, variant?: string): Promise<string> {
    ...
    try {
      ...
      const pngImagePath = `/public_assets/images/buildings/${buildingType}.png`;
      ...
      const fallbackImagePath = '/public_assets/images/buildings/contract_stall.png';
