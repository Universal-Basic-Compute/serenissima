...
/**
 * WaterFacade class for managing water rendering in Three.js
 */
export class WaterFacade {
  ...
  /**
   * Dispose of water resources to prevent memory leaks
   */
  public dispose(): void {
    // Clean up uniforms
    this.uniforms.forEach(uniform => {
      // Check if the uniform value exists and has a dispose method
